...
params, grads, costs = optimize(w, b, X, Y, num_iter= 100, learning_rate = 0.009, print_cost = True)
...
def model(X_train, Y_train, X_test, Y_test, num_iter = 2000, learning_rate = 0.5, print_cost = False):
    ...
    parameters, grads, costs = optimize(w,b,X_train,Y_train,num_iter,learning_rate, print_cost=True)
    w = parameters["w"]
    b = parameters["b"]
